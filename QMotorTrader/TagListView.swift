...
public class TagListView: UIView {
    ...
    public override func prepareForInterfaceBuilder() {
        addTag("Welcome", id: 0)
        addTag("to", id: 1)
        addTag("TagListView", id: 2).selected = true
    }
    ...
    public func addTag(title: String, id: Int) -> TagView {
        ...
        tagView.addTarget(self, action: #selector(TagListView.tagPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
